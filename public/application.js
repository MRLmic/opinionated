...
// Hyp Calls
var newHyp = function newHyp(data) {
  return $.ajax({
...
var getOne = function getOne(hypId) {
  return $.ajax({
...
var delHyps = function delHyps(hypId) {
  return $.ajax({
    url: config.apiOrigin + '/hypotheses/' + hypId,
    method: 'DELETE',
    headers: {
...
var edHyp = function edHyp(hypId, content) {
  return $.ajax({
    url: config.apiOrigin + '/hypotheses/' + hypId,
    method: 'PATCH',
    headers: {
...
// Argument Calls
var newArg = function newArg(content, position, hypothesisId) {
  return $.ajax({
...
var delArgs = function delArgs(argId) {
  return $.ajax({
...
var edArg = function edArg(argId, content) {
  return $.ajax({
    url: config.apiOrigin + '/arguments/' + argId,
    method: 'PATCH',
    headers: {
...
var store = __webpack_require__(3);
var hypsHandles = __webpack_require__(10);
...
var signInSuccess = function signInSuccess(data) {
  ...
  $('#home').hide();
  $('.hyp-wrapper').show();
  api.getHyps().then(ui.onGetHSuccess);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<h3 class=\"hyp-title\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" contenteditable=\"false\"><a data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"hyp-select\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</a><section data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"button-group\"><button type=\"button\" name=\"button\" class=\"btn btn-danger btn-xs\"><span class=\"glyphicon glyphicon-remove\"></span></button>\n<button type=\"button\" data-toggle=\"tooltip\" title=\"click once then click on text to edit, then click again to submit\" name=\"button\" class=\"edit btn btn-primary btn-xs\"><span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span></button>\n</section></h3>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.hypotheses : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var store = __webpack_require__(3);
var argHandles = __webpack_require__(35);
var api = __webpack_require__(7);
var hypsHandles = __webpack_require__(10);
var hypHandle = __webpack_require__(13);

// Hypotheses UI
var onNewHypSuccess = function onNewHypSuccess(data) {
  store.hypotheses = data.hypotheses;
  api.getHyps().then(onGetHSuccess).then(function () {
    window.scrollTo(0, document.body.scrollHeight);
  });
  $('#new-hyp').trigger('reset');
};

var onGetHSuccess = function onGetHSuccess(data) {
  $('.hyp-feed').text('');
  var hypsHTML = hypsHandles({ hypotheses: data.hypotheses });
...
var onOneSuccess = function onOneSuccess(data) {
  $('#new-arg').show();
  $('.arg-feed-wrapper').show();
  $('#new-hyp').hide();
  $('.hyp-wrapper').hide();
  $('.single').show();
  var hypHTML = hypHandle({ hypothesis: data.hypothesis });
  $('.single').append(hypHTML);
  $('#home').show();
};

// Arg Functions
var onNewArgSuccess = function onNewArgSuccess(data) {
  store.arguments = data.arguments;
  api.getArgs().then(onGetSuccess).then(function () {
    window.scrollTo(0, document.body.scrollHeight);
  });
};
...
var onGetSuccess = function onGetSuccess(data) {
  $('.arg-feed').text('');
  var argHTML = argHandles({ arguments: data.arguments });
  $('.arg-feed').append(argHTML);
  for (var i = 0; i < data.arguments.length; i++) {
    var el = document.getElementById('current-hyp');
    var hypothesisId = el.getAttribute('data-id');
    ...
    for (var _i = 0; _i < data.arguments.length; _i++) {
      if (store.user.id !== data.arguments[_i].user_id) {
        $('[data-id="' + data.arguments[_i].id + '"].button-group').hide();
      } else {
        $('[data-id="' + data.arguments[_i].id + '"].button-group').show();
      }
    }
...
var onDeleteArgSuccess = function onDeleteArgSuccess(data) {
  $('.bubble').text('Argument Retracted').animate({ opacity: 1 }).delay(550).animate({ opacity: 0 });
  api.getArgs().then(onGetSuccess);
};

var onDeleteArgFailure = function onDeleteArgFailure(data) {
  $('.bubble').text('The Internet is Forever. There was a problem 📢').animate({ opacity: 1 }).delay(550).animate({ opacity: 0 });
};

var onDeleteHypSuccess = function onDeleteHypSuccess(data) {
  api.getHyps().then(onGetHSuccess);
};

module.exports = {
  onNewArgSuccess: onNewArgSuccess,
  onGetSuccess: onGetSuccess,
  onDeleteArgSuccess: onDeleteArgSuccess,
  onDeleteArgFailure: onDeleteArgFailure,
  onNewHypSuccess: onNewHypSuccess,
  onGetHSuccess: onGetHSuccess,
  onOneSuccess: onOneSuccess,
  onDeleteHypSuccess: onDeleteHypSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<h2 id=\"current-hyp\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.hypothesis : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.hypothesis : depth0)) != null ? stack1.title : stack1), depth0))
    + "</h2>\n";
},"useData":true});
...
var authEvents = __webpack_require__(36);
var hypEvents = __webpack_require__(38);
$(function () {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.position : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "  <div data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" contenteditable=\"false\" class=\"pro-point\">\n    "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.content : stack1), depth0))
    + "<br><section data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\"class=\"button-group\"><button type=\"button\" name=\"button\" class=\"btn btn-danger btn-xs\"><span class=\"glyphicon glyphicon-remove\"></span></button>\n    <button type=\"button\" data-toggle=\"tooltip\" title=\"click once then click on text to edit, then click again to submit\" name=\"button\" class=\"edit btn btn-primary btn-xs\"><span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span></button>\n  </section>\n  </div>\n";
  ...
  return "  <div data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" contenteditable=\"false\" class=\"con-point\">\n    "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.content : stack1), depth0))
    + "<br><section data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"button-group\"><button type=\"button\" name=\"button\" class=\"del-arg btn btn-danger btn-xs\"><span class=\"glyphicon glyphicon-remove\"></span></button>\n    <button data-toggle=\"tooltip\" title=\"click once then click on text to edit, then click again to submit\" type=\"button\" name=\"button\" class=\"edit btn btn-primary btn-xs\"><span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span></button>\n  </section>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.arguments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var hypHandle = __webpack_require__(13);
// Hypotheses Events
var newHyp = function newHyp(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.newHyp(data).then(ui.onNewHypSuccess);
};

var showHypotheses = function showHypotheses(event) {
  event.preventDefault();
  api.getHyps().then(ui.onGetHSuccess).catch(ui.onGetHFailure);
};

var showHyp = function showHyp(event) {
  event.preventDefault();
  if ($(event.target).hasClass('hyp-select')) {
    var hypId = $(event.target).attr('data-id');
    api.getOne(hypId).then(ui.onOneSuccess).catch(ui.onOneFailure);
  }
};

var deleteHyp = function deleteHyp(event) {
  event.preventDefault();
  if ($(event.target).closest('button').hasClass('btn-danger') || $(event.target).hasClass('btn-danger')) {
    var hypId = $(event.target).closest('h3').attr('data-id');
    api.delHyps(hypId).then(ui.onDeleteHypSuccess).catch(ui.onDeleteHypFailure);
    ...
    $($(event.target).closest('h3')).on('keydown paste', function (event) {
    ...
    $(event.target).closest('a').toggleClass('hyp-select');
    var _hypId = $(event.target).closest('h3').attr('data-id');
    var content = event.target.closest('h3').innerText;
    api.edHyp(_hypId, content);
  }
};

// Arguments Events
var newArg = function newArg(event) {
  event.preventDefault();
  var data = getFormFields(this);
  var content = data.argument.content;
  var position = data.argument.position;
  var el = document.getElementById('current-hyp');
  var hypothesisId = el.getAttribute('data-id');
  api.newArg(content, position, hypothesisId).then(ui.onNewArgSuccess).then($(this).trigger('reset')).catch(ui.onNewArgFailure);
};

var showArguments = function showArguments(event) {
  event.preventDefault();
  api.getArgs().then(ui.onGetSuccess).catch(ui.onGetFailure);
};

var deleteArgument = function deleteArgument(event) {
  event.preventDefault();
  if ($(event.target).closest('button').hasClass('btn-danger') || $(event.target).hasClass('btn-danger')) {
    var argId = $(event.target).closest('div').attr('data-id');
    api.delArgs(argId).then(ui.onDeleteArgSuccess).catch(ui.onDeleteArgFailure);
  } else if ($(event.target).closest('button').hasClass('edit') || $(event.target).hasClass('edit')) {
    $(event.target).closest('button').toggleClass('edit btn-success btn-primary edits');
    $(event.target).closest('div').attr('contenteditable', 'true');
    $($(event.target).closest('div')).on('keydown paste', function (event) {
    ...
    var _argId = $(event.target).closest('div').attr('data-id');
    var content = event.target.closest('div').firstChild.textContent;
    api.edArg(_argId, content);
  }
};
